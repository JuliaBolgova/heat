...
namespace HeatCalc
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            double eps = 0.1; // погрешность
            double r = 0.2; // число Куранта
            ...
            int K = 50; // Место соединения двух материалов
            ...
            double tau = h * h * r; // Шаг по времени

            double ro1 = 7800; // Плотность 1 материала
            double ro2 = 7800; // Плотность 2 материала
            double lyamb1 = 38.5; // Теплопроводность 1 материала
            double lyamb2 = 38.5; // Теплопроволность 2 материала
